export function ChatInput({ value, onChange, onSend, disabled, placeholder }) {
  ...
  return (
    ...
    >
      <div
        className="flex gap-2 rounded-xl items-end focus-within:ring-2"
        style={{
      ...
      >
        ...
        <button
          ...
          style={{
            backgroundColor: value.trim() ? "#10a37f" : "var(--bg-secondary)",
            color: "#fff",
          }}
        >
          <svg
      ...
      >
        AI se galti ho sakti hai. Jaankari khud verify karein.
      </p>
    </div>
  );
}
